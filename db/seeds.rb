...
# annoyed = Word.create(word: 'annoyed', definition: 'to be annoyed')
# tired = Word.create(word: 'tired', definition: 'to be tired')
# blissful = Word.create(word: 'blissful', definition: 'to be blissful')
# ecstatic = Word.create(word: 'ecstatic', definition: 'to be ecstatic')
# horrified = Word.create(word: 'horrified', definition: 'to be horrified')
# wowed = Word.create(word: 'wowed', definition: 'to be wowed')
